...
namespace CryptoTracker.Prices
{
    public class Worker : BackgroundService
    {
        ...
        private async Task<string> ObtemPrecosAtivosPortfolio()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get, "https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?limit=5000&aux=num_market_pairs,cmc_rank,date_added,platform");
